...
- [x] Phase 5：`scripts/e2e-vm.mjs` 9 断言两连绿（boot/导航/集合 list-select-edit-save/Test connection/主题），fixture 经 HTTP 还原零残留；auto/README vm 章节 + VG 清单 + 已知偏差重写；KNOWN-DEBT 登记（见下）
