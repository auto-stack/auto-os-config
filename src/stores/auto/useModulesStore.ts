...
}}if (hit) {let ncls: string = 'nav-item w-full text-left flex items-start gap-3 pl-[28px] pr-3 py-[10px] rounded';
...
}}if (shit) {let scls: string = 'nav-item w-full text-left flex items-start gap-3 px-3 py-[10px] rounded';
